...
public class JSFUtil {
   ...
   */
    ...
    */
    ...
    public static void  invokeQueryMethodExpression(String expr, QueryEvent queryEvent) {
    ...
    public static String uploadFile(UploadedFile file, BlobDomain bFile) {
    ...
    public static void downloadFile(BlobDomain bFile, OutputStream outputStream) {                                 
        BlobDomain blob =  bFile;
        try
        ...
        catch (IOException e)
        {
            // handle errors
            e.printStackTrace();
            FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_ERROR, e.getMessage(), "Download Failed");
