...
public class SchoolSystemAMImpl extends ApplicationModuleImpl implements SchoolSystemAM {
    ...
    public void copyStudentToAttendance() {
        ...
        while (rsi.hasNext()) {
            ...
            nRow.setAttribute("RollNo", tRow.getAttribute("RollNo"));
            nRow.setAttribute("Month", month);
            attVo.insertRow(nRow);
            ...
            System.out.println("tRow.getAttribute(\"month\")"+month);
            System.out.println("tRow.getAttribute(\"RollNo\")"+tRow.getAttribute("RollNo"));            
    ...
    /**
     * Container's getter for AllocationListVO1.
     * @return AllocationListVO1
     */
    public ViewObjectImpl getAllocationListVO1() {
        return (ViewObjectImpl) findViewObject("AllocationListVO1");
    }

    /**
     * Container's getter for SNoticeBoardVO1.
     * @return SNoticeBoardVO1
     */
    public ViewObjectImpl getSNoticeBoardVO1() {
        return (ViewObjectImpl) findViewObject("SNoticeBoardVO1");
    }

    /**
     * Container's getter for SStudentRVO1.
     * @return SStudentRVO1
     */
    public ViewObjectImpl getSStudentRVO1() {
        return (ViewObjectImpl) findViewObject("SStudentRVO1");
    }

    /**
     * Container's getter for SUsersVO1.
     * @return SUsersVO1
     */
    public ViewObjectImpl getSUsersVO1() {
        return (ViewObjectImpl) findViewObject("SUsersVO1");
    }
    public String Login(String userId, String password) {
        ViewObjectImpl loginVO = getLoginVO1();        
        loginVO.setNamedWhereClauseParam("bUserId", userId);
        loginVO.setNamedWhereClauseParam("bPassword", password);       
        loginVO.executeQuery();
        System.out.println("loginVO.getEstimatedRowCount()"+loginVO.getEstimatedRowCount());
        if(loginVO.getEstimatedRowCount()>0) {
            return "success";
        }
        return "fail";
    }
     ...
     * @return LoginVO1
     */
    public ViewObjectImpl getLoginVO1() {
        return (ViewObjectImpl) findViewObject("LoginVO1");
    }

    /**
     * Container's getter for SStudentVO3.
     * @return SStudentVO3
     */
    public SStudentVOImpl getSStudentVO3() {
        return (SStudentVOImpl) findViewObject("SStudentVO3");
    }
}
